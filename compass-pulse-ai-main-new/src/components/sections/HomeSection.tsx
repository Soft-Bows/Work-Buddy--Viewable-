...
// Card backgrounds bumped twice now: /60·dark:/10 → /78·dark:/22 (still not enough contrast per
// feedback) → /90·dark:/38. The colourful title text sitting directly on these washes was losing
// contrast against the more vivid backdrop scenes showing through the old, very sheer tint,
// especially in dark mode. Still visibly translucent at the card edges/gaps, just no longer thin
// enough to fight the text.
const HOME_TEAM_ROW_COLORS = [
  { border: "border-l-teal-500", chip: "bg-teal-500 text-white", text: "text-teal-700 dark:text-teal-300", cardBorder: "border-teal-300/60 dark:border-teal-500/40", cardBg: "bg-teal-50/90 dark:bg-teal-900/38", dot: "bg-teal-500" },
  { border: "border-l-violet-500", chip: "bg-violet-500 text-white", text: "text-violet-700 dark:text-violet-300", cardBorder: "border-violet-300/60 dark:border-violet-500/40", cardBg: "bg-violet-50/90 dark:bg-violet-900/38", dot: "bg-violet-500" },
  { border: "border-l-rose-500", chip: "bg-rose-500 text-white", text: "text-rose-700 dark:text-rose-300", cardBorder: "border-rose-300/60 dark:border-rose-500/40", cardBg: "bg-rose-50/90 dark:bg-rose-900/38", dot: "bg-rose-500" },
