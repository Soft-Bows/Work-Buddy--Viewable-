...
export const seedPulseResponses: PulseResponse[] = [
  ...
  { id: "pr-seed-5", respondentName: "Diana Chang", department: "Credit Risk Management", quarter: CURRENT_QUARTER, submittedAt: daysAgo(21), ratings: { workload: 3, clarity: 4, support: 4, growth: 3 } },
  { id: "pr-seed-6", respondentName: "Elton Phua", department: "Credit Risk Management", quarter: CURRENT_QUARTER, submittedAt: daysAgo(20), ratings: { workload: 3, clarity: 4, support: 5, growth: 4 } },
  { id: "pr-seed-7", respondentName: "Bella Lim", department: "Credit Risk Management", quarter: CURRENT_QUARTER, submittedAt: daysAgo(19), ratings: { workload: 4, clarity: 4, support: 4, growth: 3 } },
  ...
  ...(PRIOR_QUARTER.startsWith(`${new Date().getFullYear()}-`) ? [
    ...
    { id: "pr-seed-15", respondentName: "Diana Chang", department: "Credit Risk Management", quarter: PRIOR_QUARTER, submittedAt: daysAgo(111), ratings: { workload: 3, clarity: 3, support: 4, growth: 3 } },
    { id: "pr-seed-16", respondentName: "Elton Phua", department: "Credit Risk Management", quarter: PRIOR_QUARTER, submittedAt: daysAgo(110), ratings: { workload: 3, clarity: 4, support: 4, growth: 3 } },
    { id: "pr-seed-17", respondentName: "Bella Lim", department: "Credit Risk Management", quarter: PRIOR_QUARTER, submittedAt: daysAgo(109), ratings: { workload: 3, clarity: 3, support: 4, growth: 4 } },
  ] : []),
];
